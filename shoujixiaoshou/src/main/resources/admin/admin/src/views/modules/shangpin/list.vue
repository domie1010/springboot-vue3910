        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '二级类型' : ''">
                        <el-select v-model="searchForm.shangpinErjiTypes" placeholder="请选择二级类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in shangpinErjiTypesSelectSearch"
                               v-bind:key="index"
                               :label="item.indexName"
                               :value="item.codeIndex">
                            <!--lable是要展示的名称-->
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '所属仓库' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.shangpinCangku" placeholder="所属仓库" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shoujixiaoshou/upload/shangpinMuBan.xls"
                        >批量导入商品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpin','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="shangpinErjiTypes"
                                      header-align="center"
                                      label="二级类型">
                        <template slot-scope="scope">
                            {{scope.row.shangpinErjiValue}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '踩': "caiNumber",
                     '商品类型': "shangpinValue",
                     '二级类型': "shangpinErjiValue",
                     '商品库存': "shangpinKucunNumber",
                     '商品原价': "shangpinOldMoney",
                     '现价/个': "shangpinNewMoney",
                     '所属仓库': "shangpinCangku",
                     '商品热度': "shangpinClicknum",
                     '是否上架': "shangxiaValue",
                     '录入时间': "insertTime",
            },
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.shangpinErjiTypes!= '' && this.searchForm.shangpinErjiTypes!= undefined) {
                    params['shangpinErjiTypes'] = this.searchForm.shangpinErjiTypes
                }
                                 
                if (this.searchForm.shangpinCangku!= '' && this.searchForm.shangpinCangku!= undefined) {
                    params['shangpinCangku'] = '%' + this.searchForm.shangpinCangku + '%'
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=shangpin_erji_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.shangpinErjiTypesSelectSearch = data.data.list;
                    }
                });
            },
            //每页数
